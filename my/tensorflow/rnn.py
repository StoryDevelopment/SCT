...
def bidirectional_dynamic_rnn(cell_fw, cell_bw, inputs, sequence_length=None,
    ...
    (flat_fw_outputs, flat_bw_outputs), final_state = \
        _bidirectional_dynamic_rnn(cell_fw, cell_bw, flat_inputs, sequence_length=flat_len,
                                   ...
                                   time_major=time_major, scope=scope)
    # print('final_state0:{}   flat_fw_outputs:{}'.format(final_state[0][0].get_shape(), final_state[0][1].get_shape()))
    ...
    # print('fw_outputs:{}   flat_fw_outputs:{}'.format(fw_outputs.get_shape(), flat_fw_outputs.get_shape()))
