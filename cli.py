...
flags.DEFINE_string("data_dir", "data/dealwithdata", "Data dir [data/dealwithdata]")
flags.DEFINE_string("run_id", "0", "Run ID [0]")
flags.DEFINE_string("out_base_dir", "result", "out base dir [result]")
...
flags.DEFINE_string("shared_glove_size", "100", "Shared path [100]")
...
flags.DEFINE_string("mode", "test", " test  [test]")
flags.DEFINE_boolean("load", True, "load saved data? [True]")
flags.DEFINE_integer("load_step", 280, "load step [0]")
...
flags.DEFINE_integer("batch_size", 100, "Batch size [120]")
...
flags.DEFINE_integer("attention_layer_num", 2, "attention num layers [2]")
...
flags.DEFINE_bool("dense_net_kernel_size", 3, 'dense net kernel size')
...
flags.DEFINE_integer("log_period", 40, "Log period [100]")
flags.DEFINE_integer("eval_period", 40, "Eval period [1000]")
flags.DEFINE_integer("save_period", 40, "Save Period [1000]")
